...
const FeatureCard = ({ icon, color, title, desc, badge, badgeColor, index }) => (
  ...
  >
    ...
    <Text color="#FFFFFF" fontWeight="600" fontSize="16px" mb={2}>
      {title}
    </Text>
    <Text color="#888" fontSize="14px" lineHeight="1.6">
      {desc}
    </Text>
  </MotionBox>
);
      ...
      <Box px={[4, 8, 12, 16]} pb={20} maxW="1200px" mx="auto">
        ...
        >
          <HStack spacing={3} mb={2}>
            ...
            <Text color="#FFFFFF" fontWeight="600" fontSize="14px">
              Быстрый старт
            </Text>
          </HStack>
