...
const DocSkeleton = () => (
  <Box bg="#141820" border="1px solid #2A2E36" borderRadius="14px" p={[5, 8]}>
    ...
    <SkeletonText noOfLines={3} spacing={4} skeletonHeight="13px" startColor="#1A1D21" endColor="#2A2E36" mb={8} />

    <Skeleton h="18px" w="200px" mb={4} startColor="#1A1D21" endColor="#2A2E36" />
